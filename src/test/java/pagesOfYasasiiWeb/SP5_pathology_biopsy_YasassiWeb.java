...
public class SP5_pathology_biopsy_YasassiWeb extends  PageFactoryInitYasasiiWeb {
	public SP5_pathology_biopsy_YasassiWeb(WebDriver driver) {
		super(driver);
	}
	...
	public void patReg(String NAME , String AGE , String MBLNO , String ORGANISATION , String ADDRESS , String AADHAAR,String MRNO ,String PROVIDER ,String SERVICE) throws InterruptedException, IOException {
		...
		HSSFSheet FOFullRegTest=wb.getSheetAt(80);	
	...
	public void resultEnter(String MRNO, String URL , String User , String Password , String site) throws InterruptedException, AWTException {
