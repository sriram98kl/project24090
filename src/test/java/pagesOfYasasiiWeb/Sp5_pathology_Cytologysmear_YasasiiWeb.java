...
public class Sp5_pathology_Cytologysmear_YasasiiWeb extends  PageFactoryInitYasasiiWeb {
	public Sp5_pathology_Cytologysmear_YasasiiWeb(WebDriver driver) {
		super(driver);
	}
...
//Smear
	...
	public void patReg(String NAME , String AGE , String MBLNO , String ORGANISATION , String ADDRESS , String AADHAAR,String MRNO ,String PROVIDER ,String SERVICE) throws InterruptedException, IOException {
		...
		HSSFSheet FOFullRegTest=wb.getSheetAt(100);	
